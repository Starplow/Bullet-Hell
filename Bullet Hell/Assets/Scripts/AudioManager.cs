...
public class AudioManager : MonoBehaviour
{
    ...
    public void Play(int blockID)
    {
        

        audioSource.PlayOneShot(IDToAudio[blockID]);
    }
    ...
    //  
    //                             5: wie man den audioclip dann abspielt -> AudioManager.instance.Play((int)GameObject.GetComponent<BlockID>().myID); 
}
